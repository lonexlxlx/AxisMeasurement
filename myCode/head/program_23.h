...
class program_23 :public QThread//需要将所有 program_23替换为新的子程序号
{
	Q_OBJECT;
public:
	...
	program_23(cam_device* cam1, cam_device* cam2, cam_device* cam3, moveControl* cradDevicePtr, ls_device* lsDevicePtr, QTableWidget* tablePtr, QSqlDatabase* DbPtr, roughnessFun* roughnessObjPtr);
	~program_23();

	QString partName = "luowenceshi-ldx";//需要修改为零件名称
	QString partNub="luowenceshi-ldx";//需要修改为零件图号
