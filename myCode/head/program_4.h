...
class program_4 :public QThread
{
	Q_OBJECT;
public:
	...
	program_4(cam_device* cam1, cam_device* cam2, cam_device* cam3, moveControl* cradDevicePtr, ls_device* lsDevicePtr, QTableWidget* tablePtr, QSqlDatabase* DbPtr, roughnessFun* roughnessObjPtr);
	~program_4();

	QString partName = "涡轮连接轴";
	QString partNub = "WZ10-44-1112-290";
	...
	map <int, QString> featureMap = {
		{1,"直径"},{2,"倒角尺寸"},{3,"倒角角度"},{4,"轴向尺寸"},{5,"跳动"},{6,"圆柱度"},{7,"花键尺寸"},{8,"孔径"},{9,"粗糙度"},{10,"圆度"},{11,"螺纹中径"},{12,"键槽"}
	};
	...
	long ls_StepLength_axis5[51] = {
		623000,668000,706600,719500,723000,723300,723600,724700,725000,725300,
		726600,726900,727200,728400,728700,729000,730200,730500,730800,732000,
		732300,732600,737200,743500,743800,744100,748500,748800,749100,753600,
		753900,754100,759800,758950,759100,759250,759300,771500,771650,771800,
		771950,772100,779700,779850,780000,780150,780300,801000,823250,823450,
		823650
	};
	//光幕传感器直径测量结果存储
	double lsDiameterResult[51][10] = { //0号是一次测量值，1号为2次测量值，2号是两次均值，3号是工序卡序号,4为标准值，5为上限，6为下限，7第一次旋转距离（补偿），8第二次旋转距离（补偿），9旋转距离均值
		{ 0,0,0,104,49.8,0,-0.15,0,0,0},{ 0,0,0,101,49.8,0,-0.05,0,0,0},{ 0,0,0,100,50.04,0,-0.005,0,0,0},{ 0,0,0,58,48.7,0.2,0,0,0,0},{ 0,0,0,60,55.45,0,-0.05,0,0,0},
		{ 0,0,0,60,55.45,0,-0.05,0,0,0},{ 0,0,0,60,55.45,0,-0.05,0,0,0},{ 0,0,0,59,52.6,0.2,0,0,0,0},{ 0,0,0,59,52.6,0.2,0,0,0,0},{ 0,0,0,59,52.6,0.2,0,0,0,0},
		{ 0,0,0,60,55.45,0,-0.05,0,0,0},{ 0,0,0,60,55.45,0,-0.05,0,0,0},{ 0,0,0,60,55.45,0,-0.05,0,0,0},{ 0,0,0,59,52.6,0.2,0,0,0,0},{ 0,0,0,59,52.6,0.2,0,0,0,0},
		{ 0,0,0,59,52.6,0.2,0,0,0,0},{ 0,0,0,60,55.45,0,-0.05,0,0,0},{ 0,0,0,60,55.45,0,-0.05,0,0,0},{ 0,0,0,60,55.45,0,-0.05,0,0,0},{ 0,0,0,59,52.6,0.2,0,0,0,0},
		{ 0,0,0,59,52.6,0.2,0,0,0,0},{ 0,0,0,59,52.6,0.2,0,0,0,0},{ 0,0,0,62,53.5,0.3,0,0,0,0},{ 0,0,0,63,53.1,0.25,0,0,0,0},{ 0,0,0,63,53.1,0.25,0,0,0,0},
		{ 0,0,0,63,53.1,0.25,0,0,0,0},{ 0,0,0,63,53.1,0.25,0,0,0,0},{ 0,0,0,63,53.1,0.25,0,0,0,0},{ 0,0,0,63,53.1,0.25,0,0,0,0},{ 0,0,0,63,53.1,0.25,0,0,0,0},
		{ 0,0,0,63,53.1,0.25,0,0,0,0},{ 0,0,0,63,53.1,0.25,0,0,0,0},{ 0,0,0,67,54.1,0.25,0,0,0,0},{ 0,0,0,67,54.1,0.25,0,0,0,0},{ 0,0,0,67,54.1,0.25,0,0,0,0},
		{ 0,0,0,67,54.1,0.25,0,0,0,0},{ 0,0,0,67,54.1,0.25,0,0,0,0},{ 0,0,0,71,56.4,0.25,0,0,0,0},{ 0,0,0,71,56.4,0.25,0,0,0,0},{ 0,0,0,71,56.4,0.25,0,0,0,0},
		{ 0,0,0,71,56.4,0.25,0,0,0,0},{ 0,0,0,71,56.4,0.25,0,0,0,0},{ 0,0,0,72,58.9,0.3,-0.3,0,0,0},{ 0,0,0,72,58.9,0.3,-0.3,0,0,0},{ 0,0,0,72,58.9,0.3,-0.3,0,0,0},
		{ 0,0,0,72,58.9,0.3,-0.3,0,0,0},{ 0,0,0,72,58.9,0.3,-0.3,0,0,0},{ 0,0,0,33,75.265,0,-0.015,0,0,0},{ 0,0,0,75,76.4,0,-0.2,0,0,0},{ 0,0,0,75,76.4,0,-0.2,0,0,0},
		{ 0,0,0,75,76.4,0,-0.2,0,0,0}
	};
	//圆柱度测量参数初始化***********************************************************************************************************************************************************************
	...
	*/
	...
	long cam0_StepLength_axis5[2] = { 388000,495000 };//远心相机测量时轴5对应的点位
	...
	long cam1_prepare[2][5] = {//0号元素是5轴位置，1号元素是2轴拍照位置，2号元素是2轴退回位置,3号元素为特征的均布个数,4号是图像的绘制模式（参考主程序中的AxisMeasurement::displayImg说明）
		{-86700 - 600,-253000,-220000,10,9},{-41000 - 600,-249000,-220000,3,10} };
	...
	//pair<double, double> program_4::cam0Picture1_algorithmLuowen(HObject ho_Image, HObject ho_Image_L, double L, float OUT2, int m, double Pix_zhoujing_chuanru);//用远心相机0的第一张图像测螺纹
	double program_4::cam0Picture1_algorithmLuowen(HObject ho_Image, HObject ho_Image_L, double L, float OUT2, int m, double Pix_zhoujing_chuanru);//用远心相机0的第一张图像测螺纹
	...
	*/
	...
	double TLineFP_Chamfer_P(HObject ho_Image, double GenRect1, double GenRect2, double GenRect3, double GenRect4,
		...
		int UnionContour1, int UnionContour2,
		int FitCircleContour1, int FitCircleContour2, int FitCircleContour3, int FitCircleContour4, int FitCircleContour5);
	double TLineFP_Chamfer_P2(HObject ho_Image, double GenRect1, double GenRect2, double GenRect3, double GenRect4,
		int EdgesSubP1, int EdgesSubP2, int EdgesSubP3,
		bool Segment, int SegmentContour1, int SegmentContour2, int SegmentContour3,
		double SelectContour1, double SelectContour2, double SelectContour3,
		int UnionContour1, int UnionContour2,
	...
	void cam1Picture_keyAlgorithm(string imgPath, double& result_134, double& result_137);
