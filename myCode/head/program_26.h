...
class program_26 :public QThread//需要将所有 program_26替换为新的子程序号
{
	Q_OBJECT;
public:
	...
	program_26(cam_device* cam1, cam_device* cam2, cam_device* cam3, moveControl* cradDevicePtr, ls_device* lsDevicePtr, QTableWidget* tablePtr, QSqlDatabase* DbPtr, roughnessFun* roughnessObjPtr);
	~program_26();

	QString partName = "低压轴";//需要修改为零件名称
	QString partNub="WJ10H.13.1035A-CUCAODU";//需要修改为零件图号
