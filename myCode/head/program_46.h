...
class program_46 :public QThread//需要将所有 program_46替换为新的子程序号
{
	Q_OBJECT;
public:
	...
	program_46(cam_device* cam1, cam_device* cam2, cam_device* cam3, moveControl* cradDevicePtr, ls_device* lsDevicePtr, QTableWidget* tablePtr, QSqlDatabase* DbPtr, roughnessFun* roughnessObjPtr);
	~program_46();
