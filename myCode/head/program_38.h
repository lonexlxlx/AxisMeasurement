...
class program_38 :public QThread//需要将所有 program_38替换为新的子程序号
{
	Q_OBJECT;
public:
	...
	program_38(cam_device* cam1, cam_device* cam2, cam_device* cam3, moveControl* cradDevicePtr, ls_device* lsDevicePtr, QTableWidget* tablePtr, QSqlDatabase* DbPtr, roughnessFun* roughnessObjPtr);
	~program_38();

	QString partName = "长拉紧螺栓";//需要修改为零件名称
	QString partNub="J644123B-175";//需要修改为零件图号
