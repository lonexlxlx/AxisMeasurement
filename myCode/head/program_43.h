...
class program_43 :public QThread//需要将所有 program_43替换为新的子程序号			
{
	Q_OBJECT;
public:
	...
	program_43(cam_device* cam1, cam_device* cam2, cam_device* cam3, moveControl* cradDevicePtr, ls_device* lsDevicePtr, QTableWidget* tablePtr, QSqlDatabase* DbPtr, roughnessFun* roughnessObjPtr);
	~program_43();
	...
	//光幕传感器测量对应的移动位置		
	long ls_StepLength_axis5[2] = { 888068,890000 };
	...
	double lsDiameterResult[2][10] = { {0,0,0,198,40.0147,.1,-.1,0,0,0},{0,0,0,197,40.0147,.1,-.1,0,0,0} };
	...
	long cam2_parpare[2][3] = { {123055,-195373,120000},{126666,-195373,120000} };



	//需要修改数组为粗糙度点位总数，并写入半径信息		
	float cam2_radius[2][2] = { {20.0073,0},{20.0073,0} };


	//需要修改数组为粗糙度点位总数，并写入粗糙度尺寸信息		
	double roughnessResult[2][3] = { {18,1.4,99},{25,3,99} };
