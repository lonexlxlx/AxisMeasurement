...
class program_35 :public QThread//需要将所有 program_35替换为新的子程序号
{
	Q_OBJECT;
public:
	...
	program_35(cam_device* cam1, cam_device* cam2, cam_device* cam3, moveControl* cradDevicePtr, ls_device* lsDevicePtr, QTableWidget* tablePtr, QSqlDatabase* DbPtr, roughnessFun* roughnessObjPtr);
	~program_35();

	QString partName = "浆轴";//需要修改为零件名称
	QString partNub="WJ9A73041-270";//需要修改为零件图号
