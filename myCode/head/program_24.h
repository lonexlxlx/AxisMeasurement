...
class program_24 :public QThread//需要将所有 program_24替换为新的子程序号
{
	Q_OBJECT;
public:
	...
	program_24(cam_device* cam1, cam_device* cam2, cam_device* cam3, moveControl* cradDevicePtr, ls_device* lsDevicePtr, QTableWidget* tablePtr, QSqlDatabase* DbPtr, roughnessFun* roughnessObjPtr);
	~program_24();

	QString partName = "螺纹-HJC";//需要修改为零件名称
	QString partNub="LUOWEN-HJC";//需要修改为零件图号
