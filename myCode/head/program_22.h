...
class program_22 :public QThread//需要将所有 program_22替换为新的子程序号
{
	Q_OBJECT;
public:
	...
	program_22(cam_device* cam1, cam_device* cam2, cam_device* cam3, moveControl* cradDevicePtr, ls_device* lsDevicePtr, QTableWidget* tablePtr, QSqlDatabase* DbPtr, roughnessFun* roughnessObjPtr);
	~program_22();
	...
	//光幕传感器测量对应的移动位置
	long ls_StepLength_axis5[1] = {//需要将数组长度修改为直径测量位置的总数，并将点位信息填入
		830637 };
