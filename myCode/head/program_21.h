...
class program_21 :public QThread//需要将所有 program_21替换为新的子程序号
{
	Q_OBJECT;
public:
	...
	program_21(cam_device* cam1, cam_device* cam2, cam_device* cam3, moveControl* cradDevicePtr, ls_device* lsDevicePtr, QTableWidget* tablePtr, QSqlDatabase* DbPtr, roughnessFun* roughnessObjPtr);
	~program_21();

	QString partName = "低压轴";//需要修改为零件名称
	QString partNub="WJ10H131035A-160";//需要修改为零件图号
